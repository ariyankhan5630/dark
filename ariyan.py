#########################################
# Ariyan Bomber Fuck Israel 
# A Bangladeshi SMS Bomber Tool
# Author: ErrorError Inc.
# ariyan khan + sabina
# Version: 4.1.0
#########################################
...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/Ariyan-Error/AriyanBomber/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf AriyanBomber && git clone https://github.com/Ariyan-Error/AriyanBomber > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd AriyanBomber && python Tbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : ErrorError Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : ARIYAN SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : ARIYAN+SABINA \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Telegram @Ethicalhacker404            \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mAriyanBomber\n")
        time.sleep(0.6)
